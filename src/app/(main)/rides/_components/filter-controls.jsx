...
const RideFilterControls = ({
  ...
  const { make, bikeType, fuelType, transmission, priceRange } = currentFilters;
  ...
  const filterSections = [
    ...
    },
    {
      id: "bikeType",
      title: "Bike Type",
      options: filters.bikeTypes.map((type) => ({ value: type, label: type })),
      currentValue: bikeType,
      onChange: (value) => onFilterChange("bikeType", value),
    },
    {
      id: "fuelType",
      title: "Fuel Type",
              ...
              <Badge
                ...
                className={`cursor-pointer px-3 py-1 ${
                  section.currentValue === option.value
                    ? "bg-teal-100 hover:bg-teal-200 text-teal-900 border-teal-200"
